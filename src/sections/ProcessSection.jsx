  ...
  const steps = [
    {
      ...
      title: "Discovery",
      description:
        "Understanding your requirements, goals, and target audience through detailed discussions.",
      color: "#60a5fa",
    },
    {
      icon: <FaSketch />,
      title: "Planning",
      description:
        "Creating detailed specifications, wireframes, and architecture diagrams for your project.",
      color: "#34d399",
    },
    {
      icon: <FaCode />,
      title: "Development",
      description:
        "Building your solution with clean, efficient code following industry best practices.",
      color: "#f59e0b",
    },
    {
      icon: <FaRocket />,
      ...
      description:
        "Rigorous testing across devices and environments before deployment.",
      color: "#a78bfa",
    },
    {
      icon: <FaHandshake />,
      title: "Maintenance",
      description:
        "Ongoing support, updates, and optimization to keep your solution running smoothly.",
      color: "#f97316",
    },
  ];
